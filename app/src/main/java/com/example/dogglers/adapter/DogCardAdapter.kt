...
class DogCardAdapter(
    ...
    class DogCardViewHolder( view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        val DogImage:ImageView = view!!.findViewById(R.id.tes_image)
        val NameDog : TextView = view!!.findViewById(R.id.dogs_name)
        val DogAge : TextView = view!!.findViewById(R.id.dogs_age)
        val HobbiesDog : TextView = view!!.findViewById(R.id.dogs_hobbies)
    }
